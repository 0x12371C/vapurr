...
const outbidSrc = fs.readFileSync(path.join(dir, "OutbidUpgradeable.sol"), "utf8");
const ketlistSrc = fs.readFileSync(path.join(dir, "KetListUpgradeable.sol"), "utf8");
...
const input = {
  language: "Solidity",
  sources: {
    "OutbidUpgradeable.sol": { content: outbidSrc },
    "KetListUpgradeable.sol": { content: ketlistSrc },
...
writeOut("OutbidUpgradeable.sol", "OutbidUpgradeable", "outbid_upgradeable_impl");
writeOut("KetListUpgradeable.sol", "KetListUpgradeable", "ketlist_upgradeable_impl");
