...
pub(crate) use pns::*;
pub use zzzmail_api::{zzzmail_send_json, zzzmail_inbox_json};
...
mod tests {
    ...
    fn hot_assets_are_immutable() {
        ...
        assert_eq!(super::cache_control("vendor/three.webgpu.min.js"), "public, max-age=31536000, immutable");
