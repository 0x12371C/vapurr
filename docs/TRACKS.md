...
| Build / pack | House | **1.1.9** on TSL; Programs **1.1.9** (rev 37941b2 @ 01:31 ET); Defender quarantines local dist. Codex wallet hardening compiled+retested (shell/wallet green) — hold pack until signed + Relic security bar. | Signed 1.1.10 pack to TSL after Relic retest; then Programs hot-patch/reinstall |
...
| Token economy / Fed gV | Relic+House | **slice green** — gV 3.5% + wgV + BrowserStream walls tested | HouseFeeRemit sketch green; wire live Uni skim->creditFees; House AMM wgV deploy when Relic opens |
